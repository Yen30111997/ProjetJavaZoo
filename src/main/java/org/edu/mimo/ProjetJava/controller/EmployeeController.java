...
import org.edu.mimo.ProjetJava.service.EmployeeService;
...
public class EmployeeController {
    ...
    public EnclosureEntity addEnclosureToEmployee(@PathVariable Long id, @RequestBody EnclosureRequest enclosureRequest) {
